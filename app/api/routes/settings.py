...
AVAILABLE_MODELS = {
    "openrouter": [
        ...
        {"id": "anthropic/claude-haiku-4.5", "name": "Claude Haiku 4.5 (cheap/fast)"},
        {"id": "google/gemini-2.5-pro", "name": "Gemini 2.5 Pro"},
        {"id": "google/gemini-2.5-flash", "name": "Gemini 2.5 Flash (cheap/fast)"},
        ...
        {"id": "mistralai/mistral-7b-instruct-v0.1", "name": "Mistral 7B (cheap/fast)"},
